          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white rounded-lg shadow-lg p-6 space-y-6">
            ...
            <div className="border-b border-metallic-200 pb-6">
              <div className="flex justify-between items-start">
                <div>
                  <h1 className="text-3xl font-bold text-metallic-900">Pedido {order.orderNumber}</h1>
            ...
            {/* Timeline do Pedido */}
            <div className="border-b border-metallic-200 pb-6">
              <h2 className="text-xl font-semibold text-metallic-900 mb-4">Status do Pedido</h2>
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    {order.createdAt && <p className="text-sm text-metallic-600">{new Date(order.createdAt).toLocaleString("pt-BR")}</p>}
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    {order.paidAt && <p className="text-sm text-metallic-600">{new Date(order.paidAt).toLocaleString("pt-BR")}</p>}
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    {order.shippedAt && <p className="text-sm text-metallic-600">{new Date(order.shippedAt).toLocaleString("pt-BR")}</p>}
                    {order.trackingCode && (
                      <div className="mt-2 space-y-1">
                        ...
                        {trackingInfo?.lastStatus && (
                          <div className="text-sm text-metallic-700">
                            ...
                            {trackingInfo.updatedAt && <p className="text-xs text-metallic-600">Atualizado em {new Date(trackingInfo.updatedAt).toLocaleString("pt-BR")}</p>}
                          </div>
                        )}
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    {order.deliveredAt && <p className="text-sm text-metallic-600">{new Date(order.deliveredAt).toLocaleString("pt-BR")}</p>}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg space-y-1">
                  ...
                  {order.shippingAddress?.complement && <p className="text-sm text-metallic-600">{order.shippingAddress.complement}</p>}
              ...
              <div className="border-t border-metallic-200 pt-6">
                <div className="flex flex-wrap gap-4 justify-center">
                  ...
                  {order.status === "DELIVERED" && (
                    <Button size="lg" variant="outline" onClick={() => router.push(`/minha-conta/pedidos/${order.id}/devolucao`)} className="min-w-[200px] text-orange-600 border-orange-200 hover:bg-orange-50">
