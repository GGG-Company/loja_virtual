...
import { ArrowLeft, Package, AlertTriangle, CheckCircle, Upload, X, FileText } from 'lucide-react';
          ...
          <div className="container mx-auto px-4 max-w-lg">
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                Sua solicitação de devolução foi registrada com sucesso.
              </p>
              ...
              <div className="space-y-3">
                ...
                <Link href="/minha-conta/pedidos" className="block">
                  <Button variant="outline" className="w-full">Voltar aos Pedidos</Button>
                </Link>
              </div>
            </motion.div>
          </div>
          ...
          {!canReturn ? (
            ...
            >
              ...
              <p className="text-gray-600">
                Só é possível solicitar devolução para pedidos que já foram enviados ou entregues.
              </p>
            ...
            >
                    ...
                    <div key={item.id} className="flex items-center gap-4 p-3 border rounded-lg">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600">
                          Quantidade no pedido: {item.quantity}
                        </p>
                      </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <Textarea
                  id="details"
                  value={reasonDetails}
                  onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setReasonDetails(e.target.value)}
                  placeholder="Descreva com mais detalhes o motivo da devolução..."
                  rows={4}
                />
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <p className="text-sm text-gray-600 mb-6">
                  Para analisar sua devolução, precisamos de uma imagem ou vídeo que comprove o motivo da solicitação.
                </p>
                  ...
                  <div className="space-y-2">
                    ...
                    {imageUrl ? (
                      ...
                      <div 
                        ...
                        className="aspect-video border-2 border-dashed border-gray-300 rounded-lg flex flex-col items-center justify-center cursor-pointer hover:border-primary-500 hover:bg-gray-50 transition-all"
                      >
