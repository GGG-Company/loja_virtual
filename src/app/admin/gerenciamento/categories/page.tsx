      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-lg shadow-sm">
          ...
          <form onSubmit={handleCreate} className="space-y-4">
            ...
            <div className="flex gap-2">
              ...
              <Button variant="outline" onClick={() => setForm({ name: "", slug: "", description: "", image: "" })}>
                Limpar
              </Button>
            </div>
          </form>
        ...
        <div className="lg:col-span-2">
          ...
          <div className="space-y-3">
            ...
            {categories.length === 0 && !loading && <div className="bg-white p-6 rounded-lg text-center text-gray-500">Nenhuma categoria encontrada.</div>}
          </div>
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <div className="flex gap-2">
              <Button variant="outline" onClick={() => setPagination((prev) => ({ ...prev, page: Math.max(1, prev.page - 1) }))} disabled={pagination.page === 1}>
                Anterior
              </Button>
              <Button variant="outline" onClick={() => setPagination((prev) => ({ ...prev, page: Math.min(prev.totalPages, prev.page + 1) }))} disabled={pagination.page >= pagination.totalPages}>
                Próxima
              </Button>
            </div>
          </div>
